...
const Rules = () => (
  <Section title="Othello Rules">
    <ol className="rules-list">
      ...
      <img src="./Assets/othello3.png" alt="othello"/>
                <p class="figures"> Figure 2: Disc displayed</p>
                <img src="./Assets/othello4.png" alt="othello"/>
                ...
                <img src="./Assets/othello5.png" alt="othello"/>
                ...
                <img src="./Assets/othello6.png" alt="othello"/>
                <p class="figures">Figure 5: Disc placed here</p>
                <img src="./Assets/othello7.png" alt="othello"/>
